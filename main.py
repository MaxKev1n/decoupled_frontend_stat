...
t = np.dtype([('file_name',np.str_, 100),('instCount',np.int32),('branchMisCount',np.int32),('branches',np.int32)])
...
for i in range(0,2):
    ...
    if i == 0:
        ...
        file_dir = './batch_running'
    else:
        write_file = 'coupled_cpt_stats.txt'
        file_dir = './batch_running_2'
